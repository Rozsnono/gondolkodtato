...
export async function GET(req: Request) {
    ...
    try {
        ...
        const terms = await fetch("https://neptun3r.nyme.hu/hallgato/api/SubjectApplication/Terms", {
            method: 'GET',
            headers: {
        ...
        const subjectType = await fetch("https://neptun3r.nyme.hu/hallgato/api/SubjectApplication/SubjectTypes",
            {
                method: 'GET',
                headers: {
                    'Authorization': `${authToken}`,
        ...
        const curriculum = await fetch(`https://neptun3r.nyme.hu/hallgato/api/SubjectApplication/Curriculum?subjectType=1&termId=${termId}`,
            {
                method: 'GET',
                headers: {
                    'Authorization': `${authToken}`,
        ...
        const subjectGroup = await fetch(`https://neptun3r.nyme.hu/hallgato/api/SubjectApplication/SubjectGroup?subjectType=1&termId=${termId}&curriculumIds%5B0%5D=${curriculumId}`,
            {
                method: 'GET',
                headers: {
                    'Authorization': `${authToken}`,
